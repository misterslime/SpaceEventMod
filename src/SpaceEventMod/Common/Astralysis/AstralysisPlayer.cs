...
internal class AstralysisPlayer : ModPlayer
{
    ...
    public override void ModifyScreenPosition()
    {
        ...
        var target = _desiredPosition.ToWorldCoordinates() + visualThing;
    ...
    {
        var x = (int)(Player.Center.X / 16f);
        var y = Player.gravDir == -1 ? (int)((Player.position.Y - 0.1f) / 16f) : (int)(Player.Bottom.Y / 16f);
        var floorTile = Player.GetFloorTile(x, y);
